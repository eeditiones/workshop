...
1. Show the titles as headings (using the `heading` behaviour)
2. The `<ref>` should be less prominent: decrease font size to `19px`

![A1_heading.png](A1_heading.png)
...
Most people occurring in the document are maked with  `placeName`:
