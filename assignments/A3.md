...
* define a user name and assign a password for the user who will own the new app; make sure you remember what they are!
...
#### Identify relevant styling rules
...
Knowing this, we should adjust our ODD rules for **persName** which explicitly specified color before.
